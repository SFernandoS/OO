...
/**
 * Panel que serve para mostrar os Cliente por perfil
 * 
...
public class ListaPorPefil extends JPanel {
	...
	/**
	 * Parte para pesquisar o Perfil do Cliente, esse método funciona como um menu
	 * para isto. No fim, também chama os métodos dos outros panels.
	 * 
	 * @param contenPane
	 * @param livraria
	 */
	...
	/**
	 * Serve apenas para criar um botão para voltar ao menu na tela
	 * 
	 * @param listaPanel
	 * @return Button
	 */
	...
	// Panel infantil
	/**
	 * É um panel onde vai chamar um método para printar os cliente por perfil
	 * infantil
	 * 
	 * @param listaPanel
	 * @param livraria
	...
	// Mostra os clientes
	/**
	 * Conteúdo que vai ser printado nos panels a cima
	 * 
	 * @param panel
	 * @param livraria
	 * @param lista
